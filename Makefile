...
install: all $(MANPAGES)
	...
	@install -m 755 -v python/undertaker-unikraft-rsfdump $(DESTDIR)$(BINDIR)
	@install -m 755 -v python/undertaker-unikraft-rsf2model $(DESTDIR)$(BINDIR)
	@install -m 755 -v python/undertaker-unikraft-srcsdump $(DESTDIR)$(BINDIR)
